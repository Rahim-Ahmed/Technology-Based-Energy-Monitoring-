...
ACCESS_ID = "gnm7gqeqnqfx858py3ny"
ACCESS_KEY = "d260deebec1c494fa608847d6d48ce86"
...
def fetch_realtime_data():
    try:
        while True:
            response = openapi.get('/v1.0/iot-03/devices/status?device_ids= bff23f18a27247ae58z1si')
...
def home():  
    ...
    timestamps, currents, voltages, powers, kwh_per_minute, cost_per_minute = read_csv_data('Energy_data.csv')
